...
test("diagnosis route and result timeline expose moved stage details outside the main page", () => {
  ...
  assert.match(diagnosis, /사장님 사업은 지금/);
  ...
  assert.match(diagnosis, /href="\/diagnosis"/);
