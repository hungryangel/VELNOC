...
export const services = [
  {
    ...
    description: "사이트가 아직 없거나, 기존 홈페이지·랜딩페이지·플레이스 신호가 흩어진 사업을 위한 자산 구축 입구.",
    persona: "검색과 AI가 읽을 수 있는 첫 기반이 필요한 분께",
    monthly: ["Site · New — 신규 구축 150~300만원 (1회)", "Site · Retrofit — 기존 홈페이지·랜딩페이지 구조 정비 80~150만원 (1회)", "공통 포함: 12개월 Seed 동행", "사이트 1주년 점검 콜 30분"],
    promise: "광고비 밖에 남는 검색·AI 기반을 먼저 세웁니다.",
...
export const hardNoRows = [
  ...
  ["운영자 정체성 은폐 요청", "운영자가 본인을 드러내기를 거부하면서 \"신뢰감 있게\" 보이고 싶다는 요청"],
...
export const strongYesRows = [
  ...
  ["장인·전문가 / 1인 브랜드", "운영자 본인이 곧 콘텐츠 자산"]
];
